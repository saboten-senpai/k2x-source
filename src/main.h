...
static const int64_t DARKSEND_POOL_MAX = (64999.99*COIN);
...
static const int64_t MAX_MONEY = 150000000 * COIN; // 550M coins
...
inline int64_t GetMNCollateral(int nHeight) { return 70000; }
