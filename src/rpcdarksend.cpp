...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw runtime_error(
                ...
                "  stop         - Stop masternode configured in katana.conf\n"
                ...
                "  vote         - Vote on a Katana initiative\n"
                );
    ...
    if (strCommand == "genkey")
    {
        ...
        return CkatanacoinSecret(secret).ToString();
    }
...
Value masternodelist(const Array& params, bool fHelp)
{
                ...
                && strMode != "pubkey" && strMode != "rank" && strMode != "status" && strMode != "addr" && strMode != "votes" && strMode != "lastpaid"))
    {
        throw runtime_error(
                ...
                "  votes          - Print all masternode votes for a Katana initiative (can be additionally filtered, partial match)\n"
