...
private slots:
    ...
    QString BuyK2X(QString OrderType, double Quantity, double Rate);
    QString SellK2X(QString OrderType, double Quantity, double Rate);
